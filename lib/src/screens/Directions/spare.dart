                                  ...
                                  Positioned(
                                    ...
                                    child: Align(
                                      child: SizedBox(
                                        ...
                                        height: 25 * fem,
                                        child: Image.asset(
                                          'assets/images/page-1/images/images/search-interface-symbol-2.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                        ...
                                        child: BottomNavigationBar(
                                          ...
                                          items: [
                                            BottomNavigationBarItem(
                                              icon: Image.asset(
                                                'assets/images/page-1/images/images/truck-1.png',
                                                fit: BoxFit.cover,
                                                width: 50 * fem,
                                                height: 26 * fem,
                                              ),
                                            ...
                                            BottomNavigationBarItem(
                                              icon: Image.asset(
                                                'assets/images/page-1/images/images/motorcycle-1.png',
                                                fit: BoxFit.cover,
                                                width: 40 * fem,
                                                height: 26 * fem,
                                              ),
                                            ...
                                            BottomNavigationBarItem(
                                              icon: Image.asset(
                                                'assets/images/page-1/images/images/walk-1.png',
                                                fit: BoxFit.cover,
                                                width: 25 * fem,
                                                height: 26 * fem,
                                              ),
                                            ...
                                            BottomNavigationBarItem(
                                              icon: Image.asset(
                                                'assets/images/page-1/images/images/sport-car-1.png',
                                                fit: BoxFit.cover,
                                                width: 50 * fem,
                                                height: 26 * fem,
                                              ),
